...
class Game:
        ...
        while(1):
            ...
            while (i < len(P_List)):
                ...
                if (GPIO OF BET == HIGH):
                    ...
                    # IF THEY PLAYERS HASN'T THROWN ENOUGH DOWN TO BET FAIRLY; TELL THEM SOMETHING?
                    if ((PList[i].current_Bet + PList[i].round_Bet) < max(P_List_Bets)):
                        #CHANGE SOMETHING IN THE GUI INSTEAD OF THIS LINE
                        print ("Broke boi's dont play here; scrub")
    ...
    def updateScreen(roundCounter):
        ...
        textPPot = style.render("Your Pot ${}".format(30), True, 0x000000)
        textTPot = style.render("Table pot ${}".format(20), True, 0x000000)
        surface1.blit(textPPot, (0, 720))
        ...
        if (roundCounter < 2):
            ...
            # player's hands
            # player 1
            surface1.blit(P1.hand[0].image, (600, 700))
            surface1.blit(P1.hand[1].image, (760, 700))
            # player 2
            ...
            surface1.blit(P1.hand[1].image, (760, 700))
            # player 2
            surface1.blit(P2.hand[0].image, (0, 0))
            surface1.blit(P2.hand[1].image, (160, 0))
            # player 3
            surface1.blit(P3.hand[0].image, (1200, 0))
            surface1.blit(P3.hand[1].image, (1360, 0))
    ...
    def play_Game():
        ...
        for player in Players:
            if player.win == True:
                # DO SOME DISPLAY STUFF ?? PRINT ACROSS ALL BOARDS THAT PLAYER BLANK IS THEWINNER
                # PASS FOR NOW
                pass
