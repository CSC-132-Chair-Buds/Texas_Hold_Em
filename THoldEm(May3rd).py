...
def UDP_server():
    ...
    # data is a string in the format "b'text_here'"
    # so we 
    return data[1:]
...
def updateScreen(round_Counter, main_Char, T1, other_Char1, other_Char2):
    ...
    textP3Bet = style.render("Player 2 Current Bet ${}".format(other_Char2.current_Bet), True, (0,0,0))
    textP3Purse = style.render("Player 2 Purse ${}".format(other_Char2.purse), True, (0,0,0))
...
class Player:
    def __init__(self, betpin=0, raisepin=0, lowerpin=0, foldpin=0, bet=0, purse = 1000, fold=False, win=False, round_Bet=0):
...
big_Blind = 20
T1 = Table()
P1 = Player(18,19,20,21)
P2 = Player(24,25,26,27)
P3 = Player(17,16,13,12)
Players = [P1, P2, P3]
Game1 = Game()
